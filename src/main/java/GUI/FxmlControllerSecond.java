...
import player.AudioPlayerSecond;

public class FxmlControllerSecond implements Initializable {

    private AudioPlayerSecond audioPlayer;
    ...
    private void open() {
        ...
        this.audioPlayer = new AudioPlayerSecond(selectedFile);
